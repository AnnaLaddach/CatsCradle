...
visualised in black and outlined in white on 
the UMAP.
...
The p-value here this is limited by the default number of randomisation
...
of a spatial subset _S_ is randomly scattered across _S_ or is somehow
...
With Moran's I, we can see spatial autocorrelation of gene expressionand compute
p-values for this.  See CatsCradle spatial vignette 
...
neighbourhoods "express" cell types.  A neighbourhoods by cell types
...
performLigandReceptorAnalysis().  This produces an list with
