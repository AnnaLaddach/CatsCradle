...
cells express.  Here we see a UMAP where the points cells, coloured by
...
cellTypesPerCellTypeGraphFromCellMatrix(cellTypesPerCellTypeMatrixExtended, minWeight = 0.05, colors = colours)
```
...
As well as expressing cell types, neighbourhoods express also genes.
