...
Here we have shown that statistics for one of the gene sets that is
most tightly clustered on UMAP.  However, 31 of the 50 Hallmark gene
sets cluster with a p-value better than 0.05.

![Hallmark clustering statistics](hallmarkClusteringPValues.png){width=6in}
...
These are named vectors whose names are the Hallmark sets. Myc is a
 0-1 vector indicated membership.  MycNormalised gives these values
...
![comparing real and randomised predictions](actualVsRandomisedPredictions.png){width=6in}
