...
DimPlot(S,cols='polychrome') + ggtitle('Cell clusters on UMAP')
```
...
averageExpMatrix = getAverageExpressionMatrix(S,STranspose,layer='data')
...
Here we show the geometrically nearby genes:
