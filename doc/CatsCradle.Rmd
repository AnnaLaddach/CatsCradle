...
![cell clusters on umap](cellClustersOnUMAP.jpg){width=6in}

![gene clusters on umap](geneClustersOnUMAP.jpg){width=6in}
...
![heatmap](cellClustersVsGeneClusters.jpg){width=6in}
...
![Sankey graph](catsCradle.jpg){width=6in}
...
![Hallmark G2M](hallmark_g2m_onUMAP.jpg){width=6in}
...
![clustering statistics](g2mClusteringStats.jpg){width=6in}
...
![Hallmark clustering statistics](hallmarkClusteringPValues.jpg){width=6in}
...
![finding geometrically nearby genes](nearbyGenes.jpg){width=6in}

![finding combinatorially nearby genes](combinatorialNearbyGenes.jpg){width=6in}
